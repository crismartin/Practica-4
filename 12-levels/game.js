...
var level2 = [
  //  Comienzo, Fin,   Frecuencia,  Tipo,       Override
    [ 0,        4000,  200,         'wiggle', { x: 100, E: 200}],
    [ 30,       4030,  200,         'wiggle', { x: 50, E: 200}],
    [ 30,       4030,  200,         'wiggle', { x: 150, E: 200}],
    [ 30,       4030,  200,         'wiggle', { x: 200, E: 200}],   
    ];
...
var playGame = function() {
    ...
    // ganado el juego
    board.add(new Level(level1, nuevo_level));
...
var winGame = function() {
    Game.setBoard(3,new TitleScreen("You win!", "Perfect Win !!"));
};
...
var nuevo_level = function() {
    Game.setBoard(3,new TitleScreen("No Bad... Level 2!", 
                                    "Press fire to play again!",
                                    playGame2));
};
...
var FireBall = function(a,b,direccion) {
    this.setup ('fireball',{vy: -1200, vx: -200, direccion, damage: 20})    
    this.x = a - this.w/5; 
    this.y = b - this.h/2; 
